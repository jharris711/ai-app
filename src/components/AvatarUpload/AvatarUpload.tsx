  ...
  return (
    <div className='h-100 md:h-200'>
      {/* {toast ? (
        ...
        >
          {toast.type === 'success' ? (
            <div className='inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-amber-500 bg-amber-100 rounded-lg dark:bg-amber-800 dark:text-amber-200'>
      ...
      <div className='w-full grid gap-4 mb-4'>
        {avatarUrl ? (
          <Image
            ...
            src={avatarUrl}
            alt='Avatar'
            className='avatar image shadow rounded-md'
