          ...
          <form action='#'>
            ...
            <div className='flex items-center space-x-4'>
              <button
                ...
                disabled={loading}
                className='text-white bg-amber-500 hover:bg-amber-600 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-ambers-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800'
              >
                Update profile
              </button>
            </div>
